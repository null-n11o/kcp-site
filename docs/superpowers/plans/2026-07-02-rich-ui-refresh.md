...
- [ ] **Step 1: tailwind.config.mjs にトークンを追加**
...
- [ ] **Step 2: BaseLayout に IO スクリプトを追加**
...
- [ ] **Step 3: FadeIn の全使用箇所を Reveal に移行**
...
- [ ] **Step 1: SectionHeading.astro を書き換え**
...
- [ ] **Step 1: header 要素に id・進捗バー・transition を追加**
...
- [ ] **Step 1: Service 行のホバー演出 + 行全体リンク化**
...
- [ ] **Step 1: ブログ一覧ページのヘッダーを大型化 + グリッドを stagger 化**
