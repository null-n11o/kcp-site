...
- [ ] **Step 1: サイトマップから /download/ 配下を除外**
...
- [ ] **Step 2: Cloudflare Pages 用 `_headers` を作成**
...
- [ ] **Step 4: robots.txt と llms.txt に記載がないことを確認**
...
- [ ] **Step 3: ユーザーに Google Form の作成を依頼し、公開URLを受け取る**
...
- [ ] **Step 3: Contact.astro に第二ボタンを追加**
...
- [ ] **Step 4: index.astro に props を渡す**
