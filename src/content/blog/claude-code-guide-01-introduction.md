...
Claude 3.7 Sonnetは「市場初のハイブリッド推論モデル」と銘打たれ、SWE-bench Verified（ソフトウェアエンジニアリングのベンチマーク）でOpenAI of o1、o3-mini、DeepSeek-R1を上回るスコアを記録しました。会話型AIエージェントの実務評価指標であるTAU-benchでも、小売・航空会社の両シナリオでClaude 3.5 SonnetとOpenAI o1を超えています。
